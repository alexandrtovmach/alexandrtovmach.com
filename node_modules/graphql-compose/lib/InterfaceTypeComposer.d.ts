import { GraphQLInterfaceType, GraphQLObjectType } from 'graphql-compose/src/graphql';
import { ObjectTypeComposer } from 'graphql-compose/src/ObjectTypeComposer';
import type { GraphQLFieldConfig, GraphQLOutputType, GraphQLInputObjectType, GraphQLInputType, GraphQLResolveInfo, GraphQLTypeResolver } from 'graphql-compose/src/graphql';
...
import type { Extensions, MaybePromise, DirectiveArgs, Directive, ThunkWithSchemaComposer } from 'graphql-compose/src/utils/definitions';
...
import type { ComposeNamedInputType, ComposeNamedOutputType } from 'graphql-compose/src/utils/typeHelpers';
