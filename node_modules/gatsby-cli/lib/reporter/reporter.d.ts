...
import { ActivityStatuses } from "gatsby-cli/lib/reporter/constants";
import { IErrorMapEntryPublicApi, ErrorId } from "gatsby-cli/lib/structured-errors/error-map";
...
import { ErrorMeta, CreateLogAction, ILogIntent, IRenderPageArgs } from "gatsby-cli/lib/reporter/types";
import { AdditionalDiagnosticsOutputHandler } from "gatsby-cli/lib/reporter/redux/diagnostics";
...
declare class Reporter {
    ...
    format: chalk.Chalk & chalk.ChalkFunction & {
        ...
        Modifiers: "hidden" | "bold" | "underline" | "reset" | "dim" | "italic" | "inverse" | "strikethrough" | "visible";
        stderr: chalk.Chalk & {
            supportsColor: false | chalk.ColorSupport;
        };
    };
    ...
    }) => (((dispatch: import("redux").Dispatch<import("gatsby-cli/lib/reporter/redux/types").ISetStatus>) => void) | import("gatsby-cli/lib/reporter/redux/types").IPendingActivity)[];
