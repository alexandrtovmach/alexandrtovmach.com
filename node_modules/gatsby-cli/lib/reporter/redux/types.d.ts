import { Actions, ActivityStatuses, ActivityTypes } from "gatsby-cli/lib/reporter/constants";
import { IStructuredError, ErrorCategory } from "gatsby-cli/lib/structured-errors/types";
import { IRenderPageArgs } from "gatsby-cli/lib/reporter/types";
...
export type ActionsUnion = ICreateLog | ISetStatus | IEndActivity | IPendingActivity | IStartActivity | ICancelActivity | IUpdateActivity | IActivityErrored | ISetLogs | IRenderPageTree;
