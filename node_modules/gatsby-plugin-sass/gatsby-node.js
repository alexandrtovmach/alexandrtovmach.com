...
exports.pluginOptionsSchema = function ({
  ...
  return Joi.object({
    ...
    additionalData: Joi.alternatives().try(Joi.string(), Joi.function()).description(`Prepends Sass/SCSS code before the actual entry file. In this case, the sass-loader will not override the data option but just prepend the entry's content. Learn more at: https://webpack.js.org/loaders/sass-loader/#additionaldata`),
