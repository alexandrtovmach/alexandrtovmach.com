import {SourceSpan} from 'sass/types/logger/source_span';

export {SourceLocation} from 'sass/types/logger/source_location';
export {SourceSpan} from 'sass/types/logger/source_span';
