...
import CrossSVG from "../styles/assets/icons/cross";
import EarthSVG from "../styles/assets/icons/earth";
      ...
      >
        ...
        >
          {interpolatingStyles =>
            ...
            >
              <EarthSVG className={this.state.active ? 'earth active' : 'earth'} />
              <CrossSVG className={this.state.active ? 'cross active' : 'cross'} />
            </button>
          }
        </Motion>
      </ButtonGroup>
